<%@ Page Title="Factura" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Factura.aspx.cs" Inherits="Facturador.GHO.Cliente.Factura" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p class="text-danger">
        <asp:Literal runat="server" ID="ErrorMessage" />
    </p>
    <asp:LinkButton runat="server" CssClass="btn btn-success" Text="<span class='glyphicon glyphicon-circle-arrow-left'></span> Seguir facturando" PostBackUrl="~/Usuario/Facturar.aspx" />
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="Ticket" CssClass="col-md-2 control-label">Folio</asp:Label>
            <div class="col-md-6">
