...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
            ...
            <asp:UpdatePanel ID="upCliente" runat="server">
                <ContentTemplate>
                    ...
                    <div class="col-md-3" style="padding-top: 26px;">
                        <asp:LinkButton style="background-color: #35c135;" ID="btnSearchClient" Text="<span class='glyphicon glyphicon-search'></span> Buscar cliente..." runat="server" CssClass="btn btn-info" OnClick="btnSearchClient_Click" />
                    </div>
                    <div class="col-md-12">
        ...
        <h5><i class="fas fa-file-alt"></i> Detalles:</h5>
        <div class="row" id="cabecera">
            ...
            <div class="col-md-3">
                 <asp:UpdatePanel ID="upSerie" runat="server">
                     <ContentTemplate>
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="Serie" CssClass="control-label">Tipo de documento</asp:Label>
            ...
            <div class="col-md-5">
               <div class="form-group">
                   <asp:Label runat="server" AssociatedControlID="ddlUsoCFDI" CssClass="control-label">* Uso</asp:Label>
                ...
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="ddlMetodoPago" CssClass="col-md-4 control-label">* Método de pago</asp:Label>
        ...
        <div class="row" id="relacionado" style="display:none;">
             ...
             <div class="col-md-4">
                 <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="ddlUsoCFDI" CssClass="control-label">UUID</asp:Label>
        ...
        <asp:UpdatePanel ID="upConcepto" runat="server">
            <ContentTemplate>
                <div class="row" id="conceptos">
                    <div class="col-md-12">
                        <asp:LinkButton style="background-color: #35c135;" ID="btnSearchProducto" Text="<span class='glyphicon glyphicon-search'></span> Buscar artículo" runat="server" CssClass="btn btn-info" OnClick="btnSearchProducto_Click" />
                    </div>
                    <!-- Código -->
                    <div class="col-md-2">
                        <div class="form-group">
                        ...
                        <!-- Precio Unitario -->
                         <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="Precio" CssClass="control-label">* Precio Unitario</asp:Label>
                    ...
                    <div class="col-md-2">                    
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="Cantidad" CssClass="control-label">* Cantidad</asp:Label>
                        ...
                        <!-- Tasa / Cuota -->
                         <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="DdlTasaoCuotaIVA" CssClass="control-label">* Tasa / Cuota</asp:Label>
            ...
            <asp:UpdatePanel ID="upTotales" runat="server">
                <ContentTemplate>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <div class="col-md-11" style="margin-top: 10px;margin-bottom:10px;padding:0px;">
