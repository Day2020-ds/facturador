    ...
    public class UserTable
    {
        ...
        public IdentityUser GetUserById(string userId)
        {
            ...
            if (rows != null && rows.Count == 1)
            {
                ...
                user.Phone = string.IsNullOrEmpty(row["Phone"]) ? null : row["Phone"]; 
            }
        ...
        {
            string commandText = "Insert into Users (UserName, Id, PasswordHash, SecurityStamp, Email, Phone) values (@name, @id, @pwdHash, @SecStamp, @Email, @Phone)";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        {
            string commandText = "Update Users set UserName = @userName, PasswordHash = @pswHash, SecurityStamp = @secStamp, Email = @Email, Phone = @Phone WHERE Id = @userId";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
